...
public class BaseServlet extends HttpServlet 
{
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
         ...
         try
         {
        	 ...
        	 String aau101=request.getParameter("aau101");
        	 if(aau101!=null) 
        	 {
        		 session.setAttribute("aau101",aau101 );//存储数据
    		 }
        	 String aaj101=request.getParameter("aaj101");
        	 if(aaj101!=null) 
        	 {
        		 session.setAttribute("aaj101",aaj101 );//存储数据
    		 }
        	 String aak101=request.getParameter("aak101");
        	 if(aak101!=null) 
        	 {
