	   ...
	   <c:choose>
	     <c:when test="${rows!=null }">
		     <c:forEach items="${rows }" var="ins" varStatus="vs">
				    ...
				    <td>${ins.aab114 }</td>
				    <td>
				      <a href="#" onclick="onQuery('${ins.aab101}')">查看该老人详细信息</a>
				    </td>
				    <td>
				      <a href="#" onclick="onQueryPres('${ins.aab101}','${ins.aab103 }')">查看该老人处方情况</a>
				    </td>
				    <td>
				      <a href="#" onclick="onQueryDaily('${ins.aab101}','${ins.aab103 }')">查看该老人所有日常情况</a>
				    </td>
				  </tr>
		      </c:forEach>
