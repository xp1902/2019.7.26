...
background-color:#393D49;
 ...
 <script type="text/javascript">
   ...
   <script src="layui/uselayui.js"></script>
    ...
    <title>Ö¾Ô¸ÕßÖ÷Ò³</title>

	<ul class="layui-nav" lay-filter="">
	   <li class="layui-nav-item layui-this"><a href="<%=path%>/vol.jsp?aan101=${empty ins.aan101?param.aan101:ins.aan101 }">Ê×Ò³</a></li>
	   <li class="layui-nav-item"><a href="<%=path%>/qaddVol.html?aan101=${empty ins.aan101?param.aan101:ins.aan101 }">¸öÈËÖÐÐÄ</a></li>
	   <li class="layui-nav-item"><a href="<%=path%>/yuyueVol.jsp?aan101=${empty ins.aan101?param.aan101:ins.aan101 }">Ô¤Ô¼Ö¾Ô¸</a></li>
	   <li class="layui-nav-item"><a href="<%=path%>/zhiyuanJilu.html?aan101=${empty ins.aan101?param.aan101:ins.aan101 }">Ö¾Ô¸¼ÇÂ¼</a></li>
	   <li class="layui-nav-item"><a href="<%=path%>/zhiyuanTuandui.html?aan101=${empty ins.aan101?param.aan101:ins.aan101 }">Ö¾Ô¸ÍÅ¶Ó</a></li>
	   <li class="layui-nav-item" style="float:right;margin-right:20px">
	     <a href="javascript:;">ÎÒ</a>
	     <dl class="layui-nav-child"> <!-- ¶þ¼¶²Ëµ¥ -->
	       <dd><a href="<%=path%>/qaddVol.html?aan101=${empty ins.aan101?param.aan101:ins.aan101 }">¸öÈËÖÐÐÄ</a></dd>
	       <dd><a href="<%=path%>/shouye.jsp">ÍË³öµÇÂ¼</a></dd>
	     </dl>
	   </li>
	</ul>
