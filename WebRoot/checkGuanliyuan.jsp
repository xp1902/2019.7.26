...
<body>
<form action="<%=path%>/checkGuanliyuan.html" method="post" class="layui-form">
...
<table class="layui-table" style="width:30%;margin:30px auto;">
<caption>
                审批管理员信息
      <hr width="160">
    </caption>
   ...
   <tr>
     <td colspan="2" align="center">
       <input type="submit" name="next" value="返回"  class="layui-btn layui-btn-sm"
              formaction="<%=path%>/${empty param.aat101?'FindByIdOlderOut':'FindByIdFankuiJiashu' }.html"
...
<input type="hidden" name="aat101" value="${empty ins.aat101?param.aat101:ins.aat101 }">
