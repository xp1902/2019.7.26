...
<table class="layui-table" style="width:50%;margin:30px auto;">
   ...
   <tr>
     <td>反馈内容</td>
     <td>
       <e:text name="aat105" required="true" defval="${ins.aat105 }"/>
     </td>
   </tr>
   <tr>
     <td>提交反馈时间</td>
